    ...
    return (
        <>
            <div className="grid grid-cols-1 lg:grid-cols-2 h-screen place-items-center font-bold">
                <div
                    className="bg-[url('https://ebinterchange.com.br/wp-content/uploads/Blog-EBI.jpg')] lg:block hidden bg-no-repeat 
...
// import {use, useEffect, useState, ChangeEvent, type FormEvent } from 'react';
...
// // ORDENAR EL TRECHO DE CODIGO ANTERIOR
